...
local roundBlueRectangle, circleLeft, circleRight, buttonCircleLeft, buttonCircleRight
...
function scene:createScene( event )
	...
	-----------------------------------------------------------------------------
	roundBlueRectangle = display.newRoundedRect(80, 150 , 150, 150, 20)
	roundBlueRectangle:setFillColor(159, 162, 253)
...
local button2 = storyboard.gotoScene( "scene3", "fade", 200  )
...
local button3 = storyboard.gotoScene( "scene5", "fade", 200  )
...
buttonQuit:addEventListener("tap", buttonQuit)
	...
	--Group insert 
	group:insert( roundBlueRectangle )
