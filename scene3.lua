...
local roundPinkRectangle, circleLeft, circleRight, buttonCircleLeft, buttonCircleRight
...
function scene:createScene( event )
	...
	-----------------------------------------------------------------------------
	roundPinkRectangle = display.newRoundedRect(80, 150 , 150, 150, 20)
	roundPinkRectangle:setFillColor(253, 159, 159)
...
local button2 = storyboard.gotoScene( "scene2", "fade", 200  )
...
buttonQuit:addEventListener("tap", buttonQuit)
	...
	--Group insert 
	group:insert( roundPinkRectangle )
