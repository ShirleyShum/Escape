...
local roundRectangle, circleLeft, circleRight, buttonCircleLeft, buttonCircleRight
...
function scene:createScene( event )
	...
	-----------------------------------------------------------------------------
	roundRectangle = display.newRoundedRect(80, 150 , 150, 150, 20)
...
local button2 = storyboard.gotoScene( "scene1", "fade", 200  )
...
local button3 = storyboard.gotoScene( "scene3", "fade", 200  )
